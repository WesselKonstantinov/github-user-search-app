function UserProfile() {
  return (
    <div className="pt-8 px-6 pb-12 mt-4 bg-white rounded-2xl shadow-[0_1rem_1.875rem_-0.625rem_rgba(70,96,187,0.2)]">
      <header className="flex flex-row-reverse justify-end items-center gap-5">
        <div className="grid gap-1.5">
          <hgroup>
            <h2 className="text-anchors-aweigh text-base font-bold">
              The Octocat
            </h2>
            <p className="text-blue">@octocat</p>
          </hgroup>
          <p className="text-searching-blue">Joined 25 Jan 2011</p>
        </div>
        <img
      ...
      <ul
        role="list"
        className="mt-6 py-4.5 px-3.5 flex bg-ghost-white rounded-lg"
      >
        <li role="listitem" className="flex flex-col-reverse flex-1 gap-2">
          <span className="text-base text-anchors-aweigh text-center font-bold">
            8
          </span>
